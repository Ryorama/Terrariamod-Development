...
public class MCreatorTStone extends Elementsterrariamod.ModElement {
	@ObjectHolder("terrariamod:tstone")
	public static final Block block = null;

	public MCreatorTStone(Elementsterrariamod instance) {
		super(instance, 4);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("tstone", "tstone", blockAt -> {
