...
public class MCreatorESS extends Elementsterrariamod.ModElement {
	@ObjectHolder("terrariamod:ess")
	public static final Block block = null;

	public MCreatorESS(Elementsterrariamod instance) {
		super(instance, 99);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MCreatorEnchantedSwor.block, (int) (1)));
		}
	}
}
