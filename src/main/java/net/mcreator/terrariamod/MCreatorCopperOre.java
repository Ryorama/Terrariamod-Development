...
public class MCreatorCopperOre extends Elementsterrariamod.ModElement {
	@ObjectHolder("terrariamod:copperore")
	public static final Block block = null;

	public MCreatorCopperOre(Elementsterrariamod instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MCreatorCopper.block, (int) (1)));
		}
	}
