...
public class MCreatorCrimsonGrass extends Elementsterrariamod.ModElement {
	@ObjectHolder("terrariamod:crimsongrass")
	public static final Block block = null;

	public MCreatorCrimsonGrass(Elementsterrariamod instance) {
		super(instance, 66);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MCreatorTDirt.block, (int) (1)));
		}
	}
}
