...
public class MCreatorTLog extends Elementsterrariamod.ModElement {
	@ObjectHolder("terrariamod:tlog")
	public static final Block block = null;

	public MCreatorTLog(Elementsterrariamod instance) {
		super(instance, 13);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MCreatorTWood.block, (int) (4)));
		}
	}
}
