...
public class MCreatorTDirt extends Elementsterrariamod.ModElement {
	@ObjectHolder("terrariamod:tdirt")
	public static final Block block = null;

	public MCreatorTDirt(Elementsterrariamod instance) {
		super(instance, 11);
	}
