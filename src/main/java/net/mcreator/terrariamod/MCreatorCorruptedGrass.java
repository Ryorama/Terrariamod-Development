...
public class MCreatorCorruptedGrass extends Elementsterrariamod.ModElement {
	@ObjectHolder("terrariamod:corruptedgrass")
	public static final Block block = null;

	public MCreatorCorruptedGrass(Elementsterrariamod instance) {
		super(instance, 63);
	}
