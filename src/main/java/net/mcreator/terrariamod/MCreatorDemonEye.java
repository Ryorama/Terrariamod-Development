...
public class MCreatorDemonEye extends Elementsterrariamod.ModElement {
	public static EntityType entity = null;

	public MCreatorDemonEye(Elementsterrariamod instance) {
		super(instance, 41);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity> create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("demoneye")
				.setRegistryName("demoneye");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -1, -65485, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("demoneye"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			biome.getSpawns(EntityClassification.MONSTER).add(new Biome.SpawnListEntry(entity, 20, 3, 5));
		}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(CustomEntity.class, renderManager -> {
			return new MobRenderer(renderManager, new Modeldemoneye(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("terrariamod:textures/demon_eye.png");
				}
			};
		});
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(MCreatorLens.block, (int) (1)));
		}
	...
	public static class Modeldemoneye extends EntityModel<Entity> {
		...
		public Modeldemoneye() {
			...
			bone.cubeList.add(new ModelBox(bone, 0, 0, -4.0F, -26.0F, -4.0F, 8, 8, 8, 0.0F, false));
			bone2 = new RendererModel(this);
			bone2.setRotationPoint(0.0F, 0.0F, 0.0F);
			setRotationAngle(bone2, 0.0F, 0.0F, -0.7854F);
			bone.addChild(bone2);
			bone2.cubeList.add(new ModelBox(bone2, 8, 16, 16.0F, -19.0F, 4.0F, 0, 8, 8, 0.0F, false));
			bone2.cubeList.add(new ModelBox(bone2, 0, 16, 12.0F, -15.0F, 4.0F, 8, 0, 8, 0.0F, false));
		}
