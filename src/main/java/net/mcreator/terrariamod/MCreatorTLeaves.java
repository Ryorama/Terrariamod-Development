...
public class MCreatorTLeaves extends Elementsterrariamod.ModElement {
	@ObjectHolder("terrariamod:tleaves")
	public static final Block block = null;

	public MCreatorTLeaves(Elementsterrariamod instance) {
		super(instance, 14);
	}
