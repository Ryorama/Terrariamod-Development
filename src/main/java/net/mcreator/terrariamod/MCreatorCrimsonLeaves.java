...
public class MCreatorCrimsonLeaves extends Elementsterrariamod.ModElement {
	@ObjectHolder("terrariamod:crimsonleaves")
	public static final Block block = null;

	public MCreatorCrimsonLeaves(Elementsterrariamod instance) {
		super(instance, 67);
	}
