...
public class MCreatorEyeOfCuthulu extends Elementsterrariamod.ModElement {
	public static EntityType entity = null;

	public MCreatorEyeOfCuthulu(Elementsterrariamod instance) {
		super(instance, 46);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity> create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("eyeofcuthulu")
				.setRegistryName("eyeofcuthulu");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -65536, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("eyeofcuthulu"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerAttributes() {
			...
			if (this.getAttribute(SharedMonsterAttributes.ARMOR) != null)
				this.getAttribute(SharedMonsterAttributes.ARMOR).setBaseValue(12);
