...
public class MCreatorCorruptedLog extends Elementsterrariamod.ModElement {
	@ObjectHolder("terrariamod:corruptedlog")
	public static final Block block = null;

	public MCreatorCorruptedLog(Elementsterrariamod instance) {
		super(instance, 64);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MCreatorTWood.block, (int) (5)));
		}
	}
}
