...
public class MCreatorDaybloom extends Elementsterrariamod.ModElement {
	@ObjectHolder("terrariamod:daybloom")
	public static final Block block = null;

	public MCreatorDaybloom(Elementsterrariamod instance) {
		super(instance, 81);
	}
