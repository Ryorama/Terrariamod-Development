...
public class MCreatorWoodenWall extends Elementsterrariamod.ModElement {
	@ObjectHolder("terrariamod:woodenwall")
	public static final Block block = null;

	public MCreatorWoodenWall(Elementsterrariamod instance) {
		super(instance, 53);
	}
