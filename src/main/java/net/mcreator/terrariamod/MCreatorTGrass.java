...
public class MCreatorTGrass extends Elementsterrariamod.ModElement {
	@ObjectHolder("terrariamod:tgrass")
	public static final Block block = null;

	public MCreatorTGrass(Elementsterrariamod instance) {
		super(instance, 12);
	}
