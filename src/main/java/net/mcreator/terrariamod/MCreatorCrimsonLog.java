...
public class MCreatorCrimsonLog extends Elementsterrariamod.ModElement {
	@ObjectHolder("terrariamod:crimsonlog")
	public static final Block block = null;

	public MCreatorCrimsonLog(Elementsterrariamod instance) {
		super(instance, 68);
	}
