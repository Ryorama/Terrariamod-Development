...
public class MCreatorSS extends Elementsterrariamod.ModElement {
	@ObjectHolder("terrariamod:ss")
	public static final Block block = null;

	public MCreatorSS(Elementsterrariamod instance) {
		super(instance, 43);
	}
	...
	public static class CustomBlock extends Block {
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, IFluidState fluid) {
			...
			Block block = this;
			{
				...
				MCreatorSkS.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
