...
public class MCreatorWorkbench extends Elementsterrariamod.ModElement {
	@ObjectHolder("terrariamod:workbench")
	public static final Block block = null;

	public MCreatorWorkbench(Elementsterrariamod instance) {
		super(instance, 49);
	}
