...
public class MCreatorHellstoneore extends Elementsterrariamod.ModElement {
	@ObjectHolder("terrariamod:hellstoneore")
	public static final Block block = null;

	public MCreatorHellstoneore(Elementsterrariamod instance) {
		super(instance, 62);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MCreatorHellstone.block, (int) (1)));
		}
	}
}
