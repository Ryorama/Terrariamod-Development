...
public class MCreatorCopperBow extends Elementsterrariamod.ModElement {
	@ObjectHolder("terrariamod:copperbow")
	public static final Item block = null;
	@ObjectHolder("terrariamod:entitybulletcopperbow")
	public static final EntityType arrow = null;

	public MCreatorCopperBow(Elementsterrariamod instance) {
		super(instance, 56);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity> create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				0.5f, 0.5f)).build("entitybulletcopperbow").setRegistryName("entitybulletcopperbow"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(MCreatorTerrariamod.tab).maxDamage(100));
			setRegistryName("copperbow");
		}
		...
		public void onUsingTick(ItemStack itemstack, LivingEntity entityLiving, int count) {
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				for (int i = 0; i < entity.inventory.mainInventory.size(); i++) {
					...
					if (stack != null && stack.getItem() == new ItemStack(MCreatorTArrow.block, (int) (1)).getItem()) {
						slotID = i;
						break;
					}
				}
				if (entity.abilities.isCreativeMode || EnchantmentHelper.getEnchantmentLevel(Enchantments.INFINITY, itemstack) > 0 || slotID != -1) {
					...
					if (entity.abilities.isCreativeMode) {
						...
						if (new ItemStack(MCreatorTArrow.block, (int) (1)).isDamageable()) {
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(MCreatorTArrow.block, (int) (1));
		}
