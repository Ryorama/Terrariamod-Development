...
public class MCreatorCorruptedLeaves extends Elementsterrariamod.ModElement {
	@ObjectHolder("terrariamod:corruptedleaves")
	public static final Block block = null;

	public MCreatorCorruptedLeaves(Elementsterrariamod instance) {
		super(instance, 65);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("corruptedleaves");
		}
