...
public class MCreatorTungstenOre extends Elementsterrariamod.ModElement {
	@ObjectHolder("terrariamod:tungstenore")
	public static final Block block = null;

	public MCreatorTungstenOre(Elementsterrariamod instance) {
		super(instance, 84);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MCreatorTungsten.block, (int) (1)));
		}
	}
}
