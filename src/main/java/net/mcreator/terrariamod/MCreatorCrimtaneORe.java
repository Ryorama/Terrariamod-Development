...
public class MCreatorCrimtaneORe extends Elementsterrariamod.ModElement {
	@ObjectHolder("terrariamod:crimtaneore")
	public static final Block block = null;

	public MCreatorCrimtaneORe(Elementsterrariamod instance) {
		super(instance, 69);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MCreatorCrimtane.block, (int) (1)));
		}
	}
}
