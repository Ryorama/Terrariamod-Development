...
public class MCreatorMushP extends Elementsterrariamod.ModElement {
	@ObjectHolder("terrariamod:mushp")
	public static final Block block = null;

	public MCreatorMushP(Elementsterrariamod instance) {
		super(instance, 25);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		...
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			if (ForgeRegistries.BIOMES.getKey(biome).equals(new ResourceLocation("terrariamod:tforest")))
				biomeCriteria = true;
			if (!biomeCriteria)
				continue;
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MCreatorMush.block, (int) (1)));
		}
